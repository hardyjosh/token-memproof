...
#[hdk_extern]
pub fn get_evm_key_binding(_:()) -> ExternResult<Option<EvmKeyBinding>> {
    _get_evm_address().map_err(|e| wasm_error!(e.to_string()))
}

pub fn _get_evm_address() -> Result<Option<EvmKeyBinding>, EvmAddressError> {
